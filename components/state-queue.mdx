---
title: "State Queue: How Block Commitments Work on L1"
sidebarTitle: "State Queue"
description: "The State Queue is a Cardano smart contract that stores Sundial L2 block headers as a linked list. Operators commit blocks, watchers challenge them, and valid blocks reach finality."
---
...
GET /blocks?from={n}&to={m}       – Range of blocks
GET /block/{blockHash}            – Block by hash
```
