...
description: "The Charms bridge enables trustless Bitcoin-to-Cardano transfers using zk-SNARK proofs (Groth16 over BLS12-381) verified directly on-chain via Plutus v3 smart contracts."
---
