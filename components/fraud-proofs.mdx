---
title: "Fraud Proofs: How Invalid L2 Blocks Are Challenged"
sidebarTitle: "Fraud Proofs"
description: "Any participant can challenge an invalid Sundial L2 block with fraud proofs, run multi-step computation threads on-chain, and earn the full operator bond."
---
...
- **DOUBLE-SPEND** — requires verifying both transactions' inclusion proofs and proving the shared input, across multiple Cardano transactions.
