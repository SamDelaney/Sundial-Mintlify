---
title: "Sundial CLI Reference: midgard Command Guide"
...
| `--network <network>` | `SUNDIAL_NODE_NETWORK_ID` | `1` (Preprod) | `mainnet` or testnet magic number |

To point every command at the public testnet node, export the endpoint once in your shell:

```bash
export SUNDIAL_NODE_ENDPOINT=https://rpc.testnet.sundialprotocol.com
```
