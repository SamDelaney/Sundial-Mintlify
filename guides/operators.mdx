---
title: "Run a Sundial Layer Node as a Block Producer"
sidebarTitle: "Operators"
description: "Layer Operators process L2 transactions, commit block headers to Cardano, and earn transaction fees. Learn the requirements, responsibilities, and how to get started."
---
...
<CardGroup cols={2}>
  <Card title="Sundial-Layer-Node" icon="server">
    The L2 block-producing node. Built with TypeScript and Effect, it uses PostgreSQL for persistent state and Redis for mempool management. This is the primary node required for all Layer Operators.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Fraud Proofs" icon="shield-check" href="/components/fraud-proofs">
    Understand the 27 fraud proof types that Provers use to challenge invalid blocks — and what makes a block invalid.
  </Card>
