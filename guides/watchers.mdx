...
description: "Watchers monitor the Sundial L2 for integrity and earn rewards. Learn about the four watcher roles — Prover, Facilitator, Archivist, and Canary — and how to participate."
---
...
<Tabs>
  ...
  <Tab title="Fraud Proof Types">
    There are 27 defined fraud proof types across seven categories. The Prover service monitors for all of them.
...
<CardGroup cols={2}>
  <Card title="Fraud Proof Details" icon="shield-check" href="/components/fraud-proofs">
    Deep dive into the 27 fraud proof types, on-chain contracts, and the challenge lifecycle.
  </Card>
